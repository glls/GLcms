...
class UserController extends CMSController
{
    ...
    public function accessRules()
    {
        return [
            [
                'allow',
                'actions' => ['register', 'forgot', 'verify', 'activate', 'resetpassword'],
                'users'   => ['*']
            ],
            [
                'allow',
    ...
    public function actionRegister()
    {
        ...
        if (isset($_POST['RegistrationForm'])) {
            ...
            if ($form->save()) {
                // Try to automatically log the user in, if we fail though just redirect them to the login page
                $model = new LoginForm;
                $model->attributes = [
                    'username' => $form->email,
        ...
        $this->render('register', ['user' => $form]);
    }
    ...
    public function actionForgot()
    {
        ...
        $this->render('forgot', ['forgotform' => $form]);
    }
