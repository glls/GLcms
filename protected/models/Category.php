...
class Category extends CMSSlugActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['created, updated', 'numerical', 'integerOnly' => true],
            ['name, slug', 'length', 'max' => 255],
            ['slug', 'validateSlug'],
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            ['id, name, description, slug, created, updated', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            'posts' => [self::HAS_MANY, 'Content', 'category_id'],
        ];
    }
