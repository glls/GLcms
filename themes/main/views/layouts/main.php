                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <li><?php echo CHtml::link('Dashboard', $this->createUrl('/dashboard')); ?></li>
    ...
    <div class="row" style="margin-top: 100px;">
        <div class="col-sm-12 main">
            ...
            <div class="blog-header">
                <h1 class="blog-title">glCMS</h1>
                <p class="lead blog-description">A CMS written with the Yii Framework from scratch</p>
            </div>
            <?php echo $content; ?>
        </div>
    </div>
